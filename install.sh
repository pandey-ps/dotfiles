...
PACMAN_PKGS="hyprland hyprpaper hyprlock hypridle waybar mako alacritty fuzzel nautilus grim slurp brightnessctl wireplumber pipewire-audio pipewire-pulse sof-firmware power-profiles-daemon python-gobject libpulse wdisplays cliphist wl-clipboard fastfetch btop imv mpv noto-fonts-emoji starship gnome-calculator xdg-desktop-portal xdg-desktop-portal-hyprland xdg-desktop-portal-gtk libnotify neovim git base-devel curl pciutils seatd polkit networkmanager gnome-keyring"
AUR_PKGS="ttf-courier-prime python-pywal"
APT_PKGS="hyprland waybar mako alacritty fuzzel nautilus grim slurp brightnessctl pipewire-pulse firmware-sof-signed power-profiles-daemon python3-gi wdisplays cliphist wl-clipboard fastfetch btop imv mpv fonts-noto-color-emoji starship gnome-calculator xdg-desktop-portal xdg-desktop-portal-hyprland xdg-desktop-portal-gtk hyprlock hypridle pulseaudio-utils libnotify-bin neovim git build-essential curl seatd polkitd network-manager gnome-keyring"
DNF_PKGS="hyprland hyprpaper hyprlock hypridle waybar mako alacritty fuzzel nautilus grim slurp brightnessctl wireplumber pipewire-pulseaudio alsa-sof-firmware power-profiles-daemon python3-gobject wdisplays cliphist wl-clipboard fastfetch btop imv starship google-noto-emoji-color-fonts gnome-calculator xdg-desktop-portal xdg-desktop-portal-hyprland xdg-desktop-portal-gtk pulseaudio-utils libnotify neovim git gcc make curl seatd polkit NetworkManager gnome-keyring"
